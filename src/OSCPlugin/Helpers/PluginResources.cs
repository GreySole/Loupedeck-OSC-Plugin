namespace Loupedeck.OSCPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.OSCPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.OSCPlugin.Resources.Resource.txt`.
